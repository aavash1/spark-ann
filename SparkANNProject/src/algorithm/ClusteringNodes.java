...
public class ClusteringNodes implements Serializable {
	...
	public boolean nodeClusterValidator(CoreGraph gr, Map<Integer, LinkedList<Integer>> nodeCluster) {
	...
	public Map<Integer, LinkedList<Integer>> cluster(CoreGraph gr) {
