...
public class ANNClusteredOptimizedWithHeuristic {
	...
	public void computeWithoutTime(CoreGraph gr, boolean queryObjectType) {
		System.out.println();
	...
	public double computeWithTime(CoreGraph gr, boolean queryObjectType) {
...
//				+ gr.getEdgesWithInfo().size());
	...
	public double computeWithTimeAndHeuristicWithoutClustering(CoreGraph gr, boolean queryObjectType,
	...
	public double computeWithoutClustering(CoreGraph gr, boolean queryObjectType,
