...
public class VivetAlgorithm implements Serializable{
	...
	public void precompute(CoreGraph graph) {

		CoreGraph virtualGraph = createVirtualGraph(graph);
...
//		}
	...
	public void compute(CoreGraph graph) {
	...
	private CoreGraph createVirtualGraph(CoreGraph inputGraph) {

		CoreGraph virtualGraph = new CoreGraph(inputGraph.getDatasetName() + " virtual");			
		...
		for (cEdge e : inputGraph.getEdgesWithInfo()) {
...
//		System.out.println("New Node ID & Data Obj: " + dataObjNodeIdMap);
	...
	private void  printNewGraphInfo(CoreGraph graph) { 
